...
const ChartHoyClientes = () => {
  ...
  const labels = Object.keys(data?.grafico?.clientes?.clientesNuevos?.filtrado?.hoy) || [];
  ...
  const dataChart = {
    ...
    datasets: [
      ...
      },
      {
        ...
        data: mapData(data.grafico.clientes.clientesNuevos.filtrado.hoy),
      ...
      {
        label: 'Compraron',
        data: mapData(data.grafico.clientes.clientesCompraron.filtrado.hoy),
...
export default ChartHoyClientes;
